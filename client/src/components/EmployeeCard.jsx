  ...
  return (
    <div className='group relative card card-hover overflow-hidden'>
        ...
        <div className='absolute top-3 left-3 flex gap-2'>
            ...
            {employee.isDeleted && <span className='bg-red-500/60 font-medium text-white px-2.5 p-1 text-xs rounded'>DELETED</span>}
        </div>
        ...
        {!employee.isDeleted && (
            <div className='absolute inset-0 bg-linear-to-t from-indigo-700/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center pb-6 gap-3'>
                ...
                <button onClick={handleDelete} className='p-2.5 bg-white/90 backdrop-blur-sm text-slate-700 hover:text-rose-600 rounded-x1 shadow-lg transition-all hover:scale-105 disabled:opacity-50'>
