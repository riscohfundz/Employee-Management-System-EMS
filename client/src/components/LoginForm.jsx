          ...
          <div className='w-full max-w-md animate-fade-in'>
            ...
            <form className='space-y-5' onSubmit={handleSubmit}>
                <div>
                    ...
                    <input type="email" value={email} onChange={(event) => setEmail(event.target.value)} required placeholder='example@gmail.com' />
                </div>
                <div>
                    <label className='block text-sm font-medium text-slate-700 mb-2'>Password</label>
                    <div className='relative '>
                      <input type={showPassword ? 'text' : 'password'} onChange={(event) => setPassword(event.target.value)} required className='pr-11'placeholder='.........' />
